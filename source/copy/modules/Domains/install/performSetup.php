...
if( !isset( $install_script ) || !$install_script ){
    echo $mod_strings['ERR_NO_DIRECT_SCRIPT'];
    return;
...
$GLOBALS['sugar_config']['dbconfig']['db_name'] = $setup_db_database_name;
$GLOBALS['sugar_config']['dbconfig']['db_user_name'] = $setup_db_sugarsales_user;
$GLOBALS['sugar_config']['dbconfig']['db_password'] = $setup_db_sugarsales_password;
...
////    FINALIZE LANG PACK INSTALL
    ...
    include('modules/Domains/install/seed_data/Advanced_Password_SeedData.php');
...
FP;
    ...
    include_once('modules/Domains/install/suite_install/suite_install.php'); //TODO: logic_hooks, config settings   
